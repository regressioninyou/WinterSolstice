...
namespace WinterSolstice {
	namespace Bronya {
		...
		void Renderer2D::BeginScene(const Rossweisse::OrthographicCamera& camera)
		{
		...
		void Renderer2D::BeginScene(const Rossweisse::SceneCamera& camera)
		{
		...
		void Renderer2D::BeginScene(const Rossweisse::EditorCamera& camera)
		{
			Elysia.PlumeLock();
		...
		void Renderer2D::BeginScene(const Rossweisse::Camera& camera, const glm::mat4& transform)
		{
		...
		void Renderer2D::Flush()
		{
			...
			if (s_Data.TextIndexCount)
			{
				...
				RenderCommand::DrawIndex(s_Data.TextVertexArray, s_Data.TextIndexCount);
				s_Data.Stats.DrawCalls++;
			}
		}
