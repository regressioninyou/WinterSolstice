...
namespace WinterSolstice {
	namespace Rossweisse {
		...
		void EditorCamera::OnUpdate(Kiana::Timestep ts)
		{
		...
		void EditorCamera::OnEvent(KnowTreasure::Event& e)
		{
			KnowTreasure::EventDispatcher dispatcher(e);
			dispatcher.Dispatch<KnowTreasure::MouseScrolledEvent>(BIND_EVENT_FN(EditorCamera::OnMouseScroll));
		}

		bool EditorCamera::OnMouseScroll(KnowTreasure::MouseScrolledEvent& e)
		{
